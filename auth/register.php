<?php
    ...
    if (isset($_POST['sign_up'])) { // kalo user klik tombol sign up

        if (isset($_POST['email']) && isset($_POST['password'])) { // kalo user ngisi kotak email dan password
...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <title>KickMyCode - Sign Up</title>
